...
public final class PrimaryKey {
    ...
    public void addColumn(final String columnName, final String columnPkName, final int columnPkIndex) {
    ...
    public boolean equals(final Object other) {
        if (other != null && other instanceof PrimaryKey) {
            ...
            if (_name != null && !_name.equals(o.getName()) || _name == null && o.getName() != null) {
                return false;
            }

            if (_columns != null && !_columns.equals(o.getColumns()) || _columns == null && o.getColumns() != null) {
                return false;
            }
    ...
    @Override
    public int hashCode() {
        return ObjectUtil.nullSafeHashCode(_name) ^ ObjectUtil.nullSafeHashCode(_columns);
    }
