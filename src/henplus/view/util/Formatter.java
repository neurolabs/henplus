...
public final class Formatter {
     ...
     * 
     * @param amount
     *            the <code>double</code> to be formatted
     * @param precision
     *            an <code>int</code>. which precision should be used?
     * @return a <code>String</code>
     */
    public static String formatNumber(final double amount, final int precision) {
        if (amount == 0.0) {
            return null;
        }
